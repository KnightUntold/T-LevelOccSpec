<?php
    ...
    echo "<html lang='en'>";
        ...
        echo "<body>";
            ...
            echo "<input type='text' name='email' id='email' required placeholder='Type Email Here'>";

            echo "<br><label for='password'>Password:</label><br>";
            echo "<input type='password' name='password' id='password' required placeholder='Type Password Here'>";
