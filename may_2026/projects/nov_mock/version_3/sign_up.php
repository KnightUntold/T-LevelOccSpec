    ...
    echo "<html lang='en'>";
        ...
        echo "<body>";
            ...
            echo "<form action='' method='post' class='center'>";
                ...
                echo "<input type='text' name='fname' id='fname' required placeholder='Type First Name Here'><br>";

                echo "<label for='lname'>Last name:</label><br>";
                echo "<input type='text' name='lname' id='lname' required placeholder='Type Last Name Here'><br>";

                echo "<label for='email'>Email:</label><br>";
                echo "<input type='email' name='email' id='email' required placeholder='Type Email Address Here'><br>";

                echo "<label for=address'>Address:</label><br>";
                echo "<input type='text' name='address' id='address' required placeholder='Type Address Here'><br>";

                echo "<label for='password'>Password:</label><br>";
                echo "<input type='password' name='password' id='password' required placeholder='Type Password Here'><br>";
