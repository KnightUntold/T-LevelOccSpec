...
function dbconn_insert(){
    ...
    $dbusername = "zoo_insert";

    $dbpassword = "fnaf"; //password for db account

    $dbname = "zoodb"; //db name to connect to
